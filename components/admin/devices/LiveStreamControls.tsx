      ...
      {streamMode === "audio" ? (
        <div className="grid grid-cols-3 gap-2">
          ...
          <button
            ...
            className={`h-10 px-2 rounded-xl text-xs font-bold border transition-all select-none flex items-center justify-center gap-1.5 active:scale-95 ${
              talking
          ...
          <button
            ...
            className="h-10 px-2 rounded-xl bg-red-500/15 hover:bg-red-500/25 border border-red-500/30 text-red-300 text-xs font-bold transition-all flex items-center justify-center gap-1.5 active:scale-95"
