    ...
    <div className="space-y-4 text-xs">
      ...
      <div className="bg-white dark:bg-white/[0.03] p-4 rounded-2xl border border-slate-200/80 dark:border-white/5 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[11px]">
          <div className={`p-3 rounded-xl border flex items-center gap-2.5 ${persistenceStatus.isAccessibility ? "bg-emerald-500/10 border-emerald-500/30 text-emerald-600 dark:text-emerald-400" : "bg-rose-500/10 border-rose-500/30 text-rose-600 dark:text-rose-400"}`}>
            ...
            <div>
              ...
              <p className="text-[10px] opacity-70">{persistenceStatus.isAccessibility ? "Active (Unkillable)" : "Inactive"}</p>
            </div>
          </div>

          <div className={`p-3 rounded-xl border flex items-center gap-2.5 ${persistenceStatus.isAdmin ? "bg-emerald-500/10 border-emerald-500/30 text-emerald-600 dark:text-emerald-400" : "bg-rose-500/10 border-rose-500/30 text-rose-600 dark:text-rose-400"}`}>
            ...
            <div>
              ...
              <p className="text-[10px] opacity-70">{persistenceStatus.isAdmin ? "Active (Protected)" : "Inactive"}</p>
            </div>
          </div>

          <div className={`p-3 rounded-xl border flex items-center gap-2.5 ${persistenceStatus.isBatteryWhitelisted ? "bg-emerald-500/10 border-emerald-500/30 text-emerald-600 dark:text-emerald-400" : "bg-rose-500/10 border-rose-500/30 text-rose-600 dark:text-rose-400"}`}>
            ...
            <div>
              ...
              <p className="text-[10px] opacity-70">{persistenceStatus.isBatteryWhitelisted ? "Unrestricted" : "Standard"}</p>
            </div>
          </div>
        </div>
      </div>
