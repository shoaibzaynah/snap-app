...
export const InstallPwaBanner: React.FC = () => {
  ...
  return (
    <div className="relative p-3.5 bg-gradient-to-r from-[#181820] to-[#101015] border border-[#FFFC00]/30 rounded-2xl shadow-xl flex items-start gap-3 animate-fadeIn text-xs">
      ...
      <div className="flex-1 space-y-1 pr-6">
        <div className="flex items-center gap-1.5">
          <span className="font-bold text-white text-sm">Install SNAP APP</span>
          <span className="px-1.5 py-0.5 rounded bg-[#FFFC00]/20 text-[#FFFC00] text-[10px] font-bold">
            Full Screen
          </span>
        </div>
        <p className="text-white/70 text-[11px] leading-relaxed">
          {isIos ? (
            <>
              ...
              <span className="inline-flex items-center gap-0.5 text-[#FFFC00] font-bold">
