    ...
    <Card className="p-5 sm:p-6 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-white/50">High-DPI 512px Retina Carto tiles &bull; Zero blur &bull; Zero watermark</p>
          </div>
        </div>
      ...
      <div className="pt-3 border-t border-slate-200 dark:border-white/5 flex items-center justify-between">
        <div>
          ...
          <span className="text-[11px] text-slate-500 dark:text-white/40">Render yellow GPS accuracy radius halo around live locator pin</span>
        </div>
        <button
