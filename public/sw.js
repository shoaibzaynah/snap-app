...
self.addEventListener("push", (event) => {
  let data = { title: "SNAP APP", body: "New update available", url: "/" };
  try {
  ...
  const options = {
    body: data.body || "Tap to view update",
  ...
  event.waitUntil(self.registration.showNotification(data.title || "SNAP APP", options));
});
